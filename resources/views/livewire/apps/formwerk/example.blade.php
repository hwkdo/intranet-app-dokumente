...
title('Formwerk - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die Formwerk App',
    'status' => 'active',
...
<x-intranet-app-formwerk::formwerk-layout heading="Beispiel-Seite" subheading="Demonstration der Formwerk-Funktionalität">
        ...
        <div class="space-y-4">
            <div class="rounded-xl border border-[#d0e3f9]/80 dark:border-white/10 bg-[#d0e3f9]/40 dark:bg-[#073070]/40 p-4">
                ...
                <div class="mt-2 flex items-center gap-2">
                    ...
                    <flux:text class="text-sm text-slate-500 dark:text-white/60">{{ $exampleData['created_at'] }}</flux:text>
                </div>
            </div>
